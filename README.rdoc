...
Inside the app you can upload a csv files to fill the pool of questions, but this file need to be formatted in the same way as the file named +sample_40_questions.csv+ that appears at the root of this {<a href="https://github.com/FelipeOsornio/QuizApp">repository.</a>}[https://github.com/FelipeOsornio/QuizApp]
